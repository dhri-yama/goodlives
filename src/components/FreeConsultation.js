...
const FreeConsultation = () => {
    return (
        <div className="w-full mt-44 lg:mt-12 relative ">
            <div className="flex flex-col h-full justify-center items-center absolute w-full bottom-44">
                <h2 className="text-5xl md:text-6xl text-center font-gilda mb-8"> Still Confused ?</h2>
                <p className="text-xl md:text-2xl font-normal text-center">
                    Are you confused about what a therapy looks like?
                </p>
                <p className="text-lg md:text-xl font-thin mt-2 text-center">
                    Don’t know when is the right time to take the first step?<br/>
                    Let us help you with it.<br/>
                </p>
                <a className="mt-4 bg-black px-6 py-4 w-96  text-center rounded-full text-white"
