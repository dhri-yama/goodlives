...
const ExpertiseCard = ({heading,content}) => {
    return (
        <div className="flex flex-col justify-center items-center h-full">
            <h2 style={{"color":"#fff"}}  className="text-6xl font-gilda mb-24 text-center">Our Area of Expertise</h2>
            <h3 style={{"color":"#c4dcdf"}}  className="uppercase text-4xl text-center">{heading}</h3>
            <p  style={{"color":"#ecf3f4"}} className="w-3/5 italic font-light text-xl text-center mt-4">
                {content}
            </p>
